...
if data_name == 'bj':
    ...
    road_name = 'chengdu_roadmap_edge_chengdu_True_1_merge'
elif data_name == 'xian':
    road_name = 'xian_roadmap_edge_xian_True_1_merge'
elif data_name == 'porto_new':
    road_name = 'porto_new_roadmap_edge_porto_new_True_1_merge'
