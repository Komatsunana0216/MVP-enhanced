...
class Config:
    ...
    def post_value_updates(cls):
        if 'porto' == cls.dataset:
            cls.dataset_prefix = 'porto_trajs'
            # 使用 99% 分位数范围，避免网格空间过大
            cls.min_lon = -8.70
            cls.max_lon = -8.53
            cls.min_lat = 41.10
            cls.max_lat = 41.25
        ...
        cls.test_dataset_file = cls.root_dir + '/data/' + cls.dataset_prefix+'_test'
