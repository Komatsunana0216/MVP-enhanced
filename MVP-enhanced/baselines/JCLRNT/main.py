...
if __name__ == '__main__':
    ...
    # 使用 porto 文件夹中的数据
    data_path = 'porto'
    save_path = os.path.join('checkpoints', 'porto')
    ...
    # train_data_files="./datasets/didi_chengdu/chengdu_1101_1115_data_sample10w.pkl"
    # task_data_files = "./datasets/didi_chengdu/chengdu_1101_1115_data_seq_evaluation.pkl"
    # train_data_files="./datasets/didi_xian/xian_1101_1115_data_sample10w.pkl"
    # task_data_files = "./datasets/didi_xian/xian_1101_1115_data_seq_evaluation.pkl"
    
    # 使用 porto 文件夹中的数据文件
    train_data_files = "./porto/porto_data.pkl"
    task_data_files = "./porto/porto_data_evaluation.pkl"
    ...
    geo_file = os.path.join(data_path, 'edge_geometry.csv')
    geometry_df = pd.read_csv(geo_file)
    trans_mat = torch.tensor(trans_mat)
    sim_srh.evaluation(model, data_path, task_data_files, num_nodes,trans_mat,geometry_df)
