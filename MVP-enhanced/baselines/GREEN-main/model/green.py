...
class GREEN(nn.Module):
    ...
    def forward(self, grid_data, road_data):
        ...
        road_padding_mask = road_traj !=Config.road_special_tokens['padding_token']
        ...
        grid_padding_mask = grid_traj !=Config.grid_special_tokens['padding_token']
    ...
    def cls_test(self, grid_data, road_data):
        ...
        return fusion_traj_emb
    def routeonly_test(self, road_data):
        g_input_feature, g_edge_index = road_data['g_input_feature'], road_data['g_edge_index']
        road_traj = road_data['road_traj']
        road_weeks, road_minutes = road_data['road_weeks'], road_data['road_minutes']
        road_type = road_data['road_type']
        ...
        return road_traj_emb
    def roadseg_test(self, grid_data, road_data):
        g_input_feature, g_edge_index = road_data['g_input_feature'], road_data['g_edge_index']
        road_traj = road_data['road_traj']
        road_lens=road_data['road_lens']
        road_weeks, road_minutes = road_data['road_weeks'], road_data['road_minutes']
        road_type = road_data['road_type']
        ...
        fusion_traj_emb = fusion_seq_emb[:, 0]
        fusion_road_emb = rnn_utils.pad_sequence([fusion_seq_emb[i, 1:length+1] for i, length in enumerate(road_lens)],
                                              padding_value=0, batch_first=True)


        return road_traj_emb, grid_traj_emb, fusion_traj_emb,fusion_road_emb